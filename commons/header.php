...
<nav style="position:fixed;width:100%;z-index:100;top:0;" class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div id="auth-cluster">
                <button type="button" class="btn btn-primary" style="margin-left : 16px;" data-bs-toggle="modal" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Register
                </button>
                <button type="button" class="btn btn-primary" style="margin-left : 6px;" data-bs-toggle="modal" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Login
                </button>
            </div>
            <button type="button" class="btn btn-danger logout" style="margin-left : 16px;" style="width:auto;" onclick='sessionStorage.clear();window.location.href="/Competitive-programming-platform";authHandle(false);' id="logout">Logout
            </button>
            ...
            <div class="modal-body">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="Log-in-tab" data-bs-toggle="tab" data-bs-target="#Log-in" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Home
                        </button>
                        <button class="nav-link" id="Sign-in-tab" data-bs-toggle="tab" data-bs-target="#Sign-in" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Profile
                        </button>
                    </div>
                </nav>
